...
parser.add_argument(
    "--output_dir", default="/tmp", help="Output directory of generated bindings"
)
parser.add_argument("--prefix", help="Prefix of Installed GNU Radio")
parser.add_argument(
    "--src",
    help="Directory of gnuradio source tree",
...
parser.add_argument(
    "--status",
    help="Location of output file for general status (used during cmake)",
    default=None,
)
parser.add_argument("--flag_automatic", default="0")
